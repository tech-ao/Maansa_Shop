...
Route::group(['middleware' => ['adminlocalize', 'demo']], function () {
    Route::prefix('admin')->group(function () { 
        ...
        Route::group(['middleware' => 'permissions:Manages Pages'], function () {
            ...
            Route::delete('page', 'Back\PageController@destroy')->name('back.page.destroy.direct');
            Route::post('page/delete', 'Back\PageController@destroy')->name('back.page.delete.post');
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::prefix('user')->group(function () {
            ...
            Route::post('/register-submit', 'Auth\User\RegisterController@register')->name('user.register.submit')->middleware('throttle:5,1');
        ...
        Route::post('/contact/submit', 'Front\FrontendController@contactEmail')->name('front.contact.submit')->middleware('throttle:5,1');
