    ...
    <div class="dash-hero-banner mb-4">
        <div class="dash-hero-content">
            <div class="dash-hero-text">
                <h2><i class="fa-solid fa-newspaper mr-2" style="font-size: 22px;"></i> {{ __('Manage Blog Categories') }}</h2>
                <p>{{ __('Organize articles, publication categories, and editorial topics across your blog.') }}</p>
            </div>
            <div class="dash-hero-actions">
                <a class="btn btn-hero-action btn-hero-primary" href="{{ route('back.bcategory.create') }}" style="font-size: 13.5px; font-weight: 700; padding: 10px 20px;">
		...
		<div class="card-modern-body">
			...
			<div class="table-responsive">
				<table class="table-modern" id="admin-table" width="100%" cellspacing="0">
					<thead>
						<tr>
							<th width="40%">{{ __('Category Name') }}</th>
							<th width="32%">{{ __('Slug') }}</th>
							<th width="16%">{{ __('Status') }}</th>
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
            <div class="modal-header bg-danger text-white border-0 py-3">
                <h5 class="modal-title d-flex align-items-center font-weight-bold" id="exampleModalLabel">
                    <i class="fas fa-exclamation-triangle mr-2"></i> {{ __('Confirm Category Deletion') }}
                </h5>
            ...
            <div class="modal-body p-4 text-center">
                ...
                <h5 class="font-weight-bold text-dark mb-2">{{ __('Delete This Blog Category?') }}</h5>
                <p class="text-muted mb-0">
                    {{ __('You are going to delete this category. All associated blogs in this category will be affected.') }}
                </p>
            </div>
