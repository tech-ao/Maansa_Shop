    ...
    <div class="dash-hero-banner mb-4">
        <div class="dash-hero-content">
            <div class="dash-hero-text">
                <h2><i class="fa-solid fa-percent mr-2" style="font-size: 22px;"></i> {{ __('Create Tax Rate') }}</h2>
                <p>{{ __('Configure a new tax bracket or value-added tax percentage rate for store products.') }}</p>
            </div>
			...
			<div class="card-modern">
				<div class="card-modern-body">
                    ...
                    <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
                        ...
                        <div>
                            <h5 class="font-weight-bold text-dark mb-0">{{ __('Tax Rate Information') }}</h5>
                            <p class="text-muted small mb-0">{{ __('Define tax title and tax percentage value') }}</p>
                        </div>
                    </div>

                    <form class="admin-form" action="{{ route('back.tax.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control" id="title"
                                    placeholder="{{ __('e.g., Standard VAT, Luxury Tax, Zero Tax') }}" value="{{ old('name') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group mb-1">
                                ...
                                <input type="number" id="price" name="value" class="form-control"
                                    placeholder="{{ __('e.g., 5.00 (Enter 0 for tax-free)') }}" min="0" step="0.01"
                                    value="{{ old('value', 0) }}" required style="font-weight: 700;">
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary px-4" style="border-radius: 10px; font-weight: 700; background: linear-gradient(135deg, #10b981, #059669); border: none; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3);">
                                <i class="fa-solid fa-plus mr-1"></i> {{ __('Create Tax Rate') }}
                            </button>
                        </div>
                    </form>
				</div>
