    ...
    <div class="dash-hero-banner mb-4">
        <div class="dash-hero-content">
            <div class="dash-hero-text">
                <h2><i class="fa-solid fa-user-plus mr-2" style="font-size: 22px;"></i> {{ __('Create System User') }}</h2>
                <p>{{ __('Add a new administrative team member and configure role permissions.') }}</p>
            </div>
					...
					<form class="admin-form" action="{{ route('back.staff.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="staff-avatar-upload-wrap">
                            ...
                            <div>
                                ...
                                <label class="btn btn-outline-primary btn-sm mb-0 cursor-pointer" style="border-radius: 8px; font-weight: 600;">
                                    <i class="fas fa-camera mr-1"></i> {{ __('Upload New Photo') }}
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name"
                                        placeholder="{{ __('Enter Full Name') }}" value="{{ old('name') }}" required>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary px-4" style="border-radius: 10px; font-weight: 700; background: linear-gradient(135deg, #10b981, #059669); border: none; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3);">
                                <i class="fa-solid fa-floppy-disk mr-1"></i> {{ __('Save User') }}
                            </button>
                        </div>
