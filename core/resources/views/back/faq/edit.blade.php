    ...
    <div class="dash-hero-banner mb-4">
        <div class="dash-hero-content">
            <div class="dash-hero-text">
                <h2><i class="fa-solid fa-pen-to-square mr-2" style="font-size: 22px;"></i> {{ __('Update FAQ Question') }}</h2>
                <p>{{ __('Edit question title, assigned category, and help center response.') }}</p>
        ...
        <div class="col-xl-8 col-lg-10 col-12 mb-4">
            <div class="card-modern">
                <div class="card-modern-body p-4">
                    <form class="admin-form" action="{{ route('back.faq.update', $faq->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="settings-section-card mb-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="title" class="form-control" id="title" placeholder="{{ __('Enter Title') }}" value="{{ $faq->title }}" required>
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea name="details" id="details" class="form-control" rows="6" placeholder="{{ __('Enter Details') }}" required>{{ $faq->details }}</textarea>
                            </div>
                        </div>
