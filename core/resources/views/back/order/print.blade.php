    ...
    <div class="invoice-print-container">
        ...
        <div class="no-print-bar">
            <div style="display: flex; gap: 8px; align-items: center;">
                ...
                <a href="{{ route('back.order.packing_label', $order->id) }}" class="btn-action" style="background: #eff6ff; color: #2563eb; border: 1px solid #bfdbfe;">
                    <svg style="width: 14px; height: 14px; margin-right: 5px; fill: currentColor;" viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10H7v-2h10v2zm0-4H7V7h10v2z"/></svg> {{ __('Packing Label') }}
                </a>
            </div>
