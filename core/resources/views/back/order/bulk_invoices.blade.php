...
<head>
    ...
    <title>{{ __('Bulk Invoices') }} ({{ $orders->count() }} {{ __('Orders') }}) - {{ $setting->title }}</title>
    <style>
        * {
    ...
    <div class="no-print-bar">
        <div style="display: flex; gap: 8px; align-items: center;">
            ...
            <span style="font-weight: 800; font-size: 13.5px; color: #0f172a; margin-left: 6px;">
                {{ $orders->count() }} {{ __('Invoice(s) Ready to Print') }}
            </span>
        </div>
        <div style="display: flex; gap: 8px; align-items: center;">
            <a href="{{ route('back.order.bulk.packing_labels', request()->all()) }}" class="btn-action btn-labels">
                <svg style="width: 14px; height: 14px; margin-right: 5px; fill: currentColor;" viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10H7v-2h10v2zm0-4H7V7h10v2z"/></svg> {{ __('Switch to Bulk Packing Labels') }}
            </a>
            <button onclick="window.print()" class="btn-action btn-print">
                <svg style="width: 15px; height: 15px; margin-right: 6px; fill: currentColor;" viewBox="0 0 24 24"><path d="M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zm-3 11H8v-5h8v5zm3-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-1-9H6v4h12V3z"/></svg> {{ __('Print All Invoices') }}
            </button>
        </div>
    </div>

    <div class="bulk-invoice-wrapper">
