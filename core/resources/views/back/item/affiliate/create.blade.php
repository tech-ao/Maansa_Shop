...
<div class="container-fluid">
    ...
    <div class="dash-hero-banner mb-4">
        <div class="dash-hero-content">
            <div class="dash-hero-text">
                <h2><i class="fa-solid fa-arrow-up-right-from-square mr-2" style="font-size: 22px;"></i> {{ __('Create Affiliate Product') }}</h2>
                <p>{{ __('Add an external affiliate or referral product with direct outbound redirect link.') }}</p>
            </div>
    ...
    <!-- Main Form -->
    <form class="admin-form tab-form" action="{{ route('back.affiliate.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-modern-body p-4">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="affiliate_link" class="form-control font-weight-bold" id="affiliate__link" placeholder="https://external-store.com/ref/item-id" value="{{ old('affiliate_link') }}" required>
                            </div>
                ...
                <div class="card-modern mb-4">
                    ...
                    <div class="card-modern-body p-4">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="sort_details" id="sort_details" class="form-control" rows="3" placeholder="{{ __('Brief highlight summary of this affiliate product...') }}">{{ old('sort_details') }}</textarea>
                        </div>

                        <div class="form-group mb-0">
                            <label for="details" class="form-label font-weight-bold text-dark">{{ __('Full Detailed Description') }} *</label>
                            <textarea name="details" id="details" class="form-control text-editor" rows="6" placeholder="{{ __('Enter full product review, features, and details...') }}">{{ old('details') }}</textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="specification_name[]" placeholder="{{ __('Specification Name (e.g., Merchant, Warranty)') }}" value="">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="specification_description[]" placeholder="{{ __('Specification Value (e.g., Amazon, 1 Year)') }}" value="">
                                    </div>
                                </div>
                                <div class="flex-btn">
