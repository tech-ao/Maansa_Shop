...
<div class="container-fluid">
    ...
    <div class="dash-hero-banner mb-4">
        <div class="dash-hero-content">
            <div class="dash-hero-text">
                <h2><i class="fa-solid fa-cloud-arrow-down mr-2" style="font-size: 22px;"></i> {{ __('Create Digital Product') }}</h2>
                <p>{{ __('Add a downloadable digital product, zip assets, eBooks, templates, or software.') }}</p>
            </div>
    ...
    <!-- Main Form -->
    <form class="admin-form tab-form" action="{{ route('back.digital.item.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-modern-body p-4">
                        ...
                        <div class="form-group d-none view_link mb-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="link" name="link" class="form-control" placeholder="https://example.com/download/file.zip">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-modern mb-4">
                    ...
                    <div class="card-modern-body p-4">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="sort_details" id="sort_details" class="form-control" rows="3" placeholder="{{ __('Brief highlight summary of this digital product...') }}">{{ old('sort_details') }}</textarea>
                        </div>
                            ...
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="specification_name[]" placeholder="{{ __('Specification Name (e.g., File Format)') }}" value="">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="specification_description[]" placeholder="{{ __('Specification Value (e.g., PDF, ZIP, PSD)') }}" value="">
                                    </div>
                                </div>
                                <div class="flex-btn">
