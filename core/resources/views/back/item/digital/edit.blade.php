    ...
    <div class="dash-hero-banner mb-4">
        <div class="dash-hero-content">
            <div class="dash-hero-text">
                <h2><i class="fa-solid fa-cloud-arrow-down mr-2" style="font-size: 22px;"></i> {{ __('Update Digital Product') }}</h2>
                <p>{{ __('Edit details, update download assets, adjust pricing, and configure product metadata.') }}</p>
            </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="card-modern mb-4">
                    ...
                    <div class="card-modern-body p-4">
                        ...
                        <div class="form-group view_file {{ $item->file_type == 'file' ? '' : 'd-none' }} mb-0">
                            <label for="file" class="form-label font-weight-bold text-dark">{{ __('Upload New Zip Package') }}</label>
                            <div class="input-group mb-1">
                                <input type="file" class="form-control" id="file" name="file">
                            </div>
                            <small class="text-warning font-weight-bold"><i class="fa-solid fa-file-zipper mr-1"></i> {{ __('File package format must be .zip (Leave blank to keep existing file: ' . $item->file . ')') }}</small>
                        </div>

                        <div class="form-group view_link {{ $item->file_type == 'link' ? '' : 'd-none' }} mb-0">
                            <label for="link" class="form-label font-weight-bold text-dark">{{ __('External Download Link URL') }} *</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fa-solid fa-globe"></i></span>
                                </div>
                                <input type="text" id="link" name="link" class="form-control" placeholder="https://example.com/download/file.zip" value="{{ $item->link }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-modern mb-4">
                    ...
                    <div class="card-modern-body p-4">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="sort_details" id="sort_details" class="form-control" rows="3" placeholder="{{ __('Brief highlight summary of this digital product...') }}">{{ $item->sort_details }}</textarea>
                        </div>
