    ...
    <div class="dash-hero-banner mb-4">
        <div class="dash-hero-content">
            <div class="dash-hero-text">
                <h2><i class="fa-solid fa-box-open mr-2" style="font-size: 22px;"></i> {{ __('Create Physical Product') }}</h2>
                <p>{{ __('Add a new standard physical item with stock inventory, variants, and shipping details.') }}</p>
            </div>
    ...
    <form class="admin-form tab-form" action="{{ route('back.item.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
                ...
                <div class="card-modern mb-4">
                    ...
                    <div class="card-modern-body p-4">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="sort_details" id="sort_details" class="form-control" rows="3" placeholder="{{ __('Brief highlight summary of this product...') }}">{{ old('sort_details') }}</textarea>
                        </div>

                        <div class="form-group mb-0">
                            <label for="details" class="form-label font-weight-bold text-dark">{{ __('Full Detailed Description') }} *</label>
                            <textarea name="details" id="details" class="form-control text-editor" rows="6" placeholder="{{ __('Enter full product description, specifications, and materials...') }}">{{ old('details') }}</textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="specification_name[]" placeholder="{{ __('Specification Name (e.g., Color, Weight)') }}" value="">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="specification_description[]" placeholder="{{ __('Specification Value (e.g., Red, 500g)') }}" value="">
                                    </div>
                                </div>
                                <div class="flex-btn">
            ...
            <div class="col-lg-4">
                ...
                <!-- Stock, Tax, SKU & Video Card -->
                <div class="card-modern mb-4">
                    <div class="card-modern-header">
                        <h6 class="font-weight-bold text-dark mb-0 d-flex align-items-center">
                            <i class="fa-solid fa-warehouse text-secondary mr-2"></i> {{ __('Inventory & Identifiers') }}
                        </h6>
                    </div>
                    <div class="card-modern-body p-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="stock" name="stock" class="form-control font-weight-bold" placeholder="{{ __('Total Stock Quantity') }}" value="{{ old('stock') }}" required>
                            </div>
                        </div>
