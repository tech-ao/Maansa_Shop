...
function MenuEditor(idSelector, options) {
    ...
    function editItem($item) {
        ...
        $main.find('li').removeClass('menu-item-editing');
        $item.addClass('menu-item-editing');
        ...
        let type = data.type;
        if (type != "custom") {
            $("#withUrl input[name='href']").closest('.form-group').hide();
        } else {
            $("#withUrl input[name='href']").closest('.form-group').show();
        }
    }
